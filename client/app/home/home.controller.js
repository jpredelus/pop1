...
class HomeController {
    constructor($scope, $timeout) {
        ...
        /**
         * Callback that is fired after slide loads
         * Updates the scope index to the current section's index
         ...
         * of the last transition. If the afterLoadfn hasn't been called then it will 
         * return true regardless of params.
         * 
         * @param  {[int]} idx: The index of the section
         * @param  {[string]} direction: direction of the last section transition can be "up" or "down",
         ...
         * 
         * 
         * @param  {String} exit: the name of the class that should be added after exiting a sextion. The default is fadeOut
